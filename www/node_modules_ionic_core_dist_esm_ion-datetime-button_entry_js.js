...
/* harmony import */ var _helpers_f586db1c_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers-f586db1c.js */ 7581);
...
/* harmony import */ var _ionic_global_a9abd569_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ionic-global-a9abd569.js */ 1171);
/* harmony import */ var _data_605c040f_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./data-605c040f.js */ 133);
...
const DatetimeButton = class {
  constructor(hostRef) {
    ...
    this.setDateTimeText = () => {
       ...
       */
      const parsedDatetimes = (0,_data_605c040f_js__WEBPACK_IMPORTED_MODULE_6__.q)(parsedValues.length > 0 ? parsedValues : [(0,_data_605c040f_js__WEBPACK_IMPORTED_MODULE_6__.t)()]);
      /**
      ...
      const use24Hour = (0,_data_605c040f_js__WEBPACK_IMPORTED_MODULE_6__.J)(locale, hourCycle);
      this.dateText = this.timeText = undefined;
      switch (datetimePresentation) {
        case 'date-time':
        case 'time-date':
          const dateText = (0,_data_605c040f_js__WEBPACK_IMPORTED_MODULE_6__.T)(locale, firstParsedDatetime);
          const timeText = (0,_data_605c040f_js__WEBPACK_IMPORTED_MODULE_6__.K)(locale, firstParsedDatetime, use24Hour);
          if (preferWheel) {
        ...
        case 'date':
          if (multiple && parsedValues.length !== 1) {
            ...
            this.dateText = (0,_data_605c040f_js__WEBPACK_IMPORTED_MODULE_6__.T)(locale, firstParsedDatetime);
          }
          break;
        case 'time':
          this.timeText = (0,_data_605c040f_js__WEBPACK_IMPORTED_MODULE_6__.K)(locale, firstParsedDatetime, use24Hour);
          break;
        case 'month-year':
          this.dateText = (0,_data_605c040f_js__WEBPACK_IMPORTED_MODULE_6__.G)(locale, firstParsedDatetime);
          break;
        case 'month':
          this.dateText = (0,_data_605c040f_js__WEBPACK_IMPORTED_MODULE_6__.S)(locale, firstParsedDatetime, {
            month: 'long'
          });
          break;
        case 'year':
     ...
     */
    this.waitForDatetimeChanges = /*#__PURE__*/(0,_home_pixel1_Desktop_last_polyonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
      if (!datetimeEl) {
    ...
    this.handleDateClick = /*#__PURE__*/function () {
      var _ref2 = (0,_home_pixel1_Desktop_last_polyonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
        const {
          datetimeEl,
          datetimePresentation
        } = _this;
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,_home_pixel1_Desktop_last_polyonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
        if (!overlayEl) {
